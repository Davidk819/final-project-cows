...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen mx-auto p-4 lg:w-1/2 xl:w-1/3">
      <p className="text-2xl lg:text-4xl mb-4">מידע יומי</p>
      {isLoading ? (
      ...
      <button
        ...
        className="bg-cyan-400 hover:bg-cyan-500 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue transition duration-300 mt-4"
      >
        Get Data
      </button>
